...
namespace Org\Util;
/*
 * 获取中文全拼（仅支持gb2312注意使用iconv("utf-8","gb2312")转码），首拼字母两种编码都支持
 * getFirstChar 取汉字第【一个】汉字完整拼音
 * pinyin_long  获取字符串汉字的各个汉字的首字母
 * getFullSpell 取得汉字的所有拼音
 * getChineseSpell  取一个汉字码对应的拼音
 * getChineseSpells 取汉字拼音
 */
